...
mod tests {
    ...
    fn run_reports_fuzzer_tests() {
        ...
        let skip: HashSet<String> = ["1761656086", "1763371531", "1763371689"]
            .iter()
            .map(|s| s.to_string())
            .collect();
    ...
    const FUZZ_REPORT: &str = "/home/bernar/workspace/vinwolf/tests/jam-conformance/fuzz-reports/0.7.2/traces/1766243315_8065";
