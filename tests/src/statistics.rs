...
mod tests {
    ...
    fn run_test(filename: &str) {
        ...
        let test_content = utils::misc::read_bin_file(std::path::Path::new(&format!("jamtestvectors/stf/statistics/{}/{}", *TEST_TYPE, filename))).unwrap();
        ...
        header.unsigned.author_index = input.author_index;
