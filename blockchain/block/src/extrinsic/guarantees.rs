...
pub mod work_report {
    ...
    -> Result<OutputDataReports, ProcessError> {
        ...
        // TODO 11.35
        if state_handler::is_ancestors_feature_enabled() && !state_handler::header::lookup_ancestor(&work_report.context.lookup_anchor_slot, &work_report.context.lookup_anchor) {
